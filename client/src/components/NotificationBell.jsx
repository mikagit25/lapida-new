...
const NotificationBell = () => {
  ...
  const showUnreadBadge = unreadCount > 0 && notificationsCount > 0;
                ...
                <div className="max-h-96 overflow-y-auto">
                  {notifications.map((notification) => (
                    <div
                      ...
                      className={`p-3 border-b border-gray-200 last:border-b-0 hover:bg-gray-50 cursor-pointer ${!notification.read ? 'bg-blue-50' : ''}`}
